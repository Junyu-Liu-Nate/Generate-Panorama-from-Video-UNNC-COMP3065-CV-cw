...
def create_lmdb_for_customized():
    # folder_path = './datasets/customized/customized_blur_v1'
    folder_path = './datasets/customized/customized_blur_v1_val'
    lmdb_path = './datasets/customized/customized_blur_v1_val.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    print(keys)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # folder_path = './datasets/customized/customized_sharp_v1'
    folder_path = './datasets/customized/customized_sharp_v1_val'
    lmdb_path = './datasets/customized/customized_sharp_v1_val.lmdb'
